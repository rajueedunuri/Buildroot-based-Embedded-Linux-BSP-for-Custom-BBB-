...
@ -D __KERNEL__ -D __LINUX_ARM_ARCH__=6 -U arm -D MODULE
...
@ -MD drivers/memory/.emif-asm-offsets.s.d
@ drivers/memory/emif-asm-offsets.c -mlittle-endian -mabi=aapcs-linux
@ -mfpu=vfp -marm -mtune=arm1136j-s -mfloat-abi=soft -mtls-dialect=gnu
@ -march=armv6k -auxbase-strip drivers/memory/emif-asm-offsets.s
...
main:
	.fnstart
.LFB1:
	.file 1 "drivers/memory/emif-asm-offsets.c"
	.loc 1 18 1 view -0
...
.LBE5:
.LBE4:
	.loc 1 21 2 view .LVU40
@ drivers/memory/emif-asm-offsets.c:22: }
	.loc 1 22 1 is_stmt 0 view .LVU41
	mov	r0, #0	@,
	bx	lr	@
.LFE1:
	.fnend
...
.LASLTP0:
	...
	.ascii	"include/linux"
	.byte	0
	.ascii	"drivers/memory"
	.byte	0
	.byte	0
	.ascii	"emif-asm-offsets.c\000"
	.uleb128 0x2
	.uleb128 0
	.uleb128 0
...
.LASF0:
	.ascii	"drivers/memory/emif-asm-offsets.dwo\000"
.LASF1:
	...
	.ascii	"signed char\000"
	.ascii	"long int\000"
	.ascii	"drivers/memory/emif-asm-offsets.c\000"
	.ascii	"unsigned int\000"
	.ascii	"long unsigned int\000"
	.ascii	"short unsigned int\000"
	.ascii	"/home/km/TR_HUB/beagleboneblack-kernel\000"
